---
title: "Rithu Gokul K." #THIS NEEDS TO BE MANUALLY SET
categories: 
 - student
---
...
memberid <- "M45" # THIS NEEDS TO BE MANUALLY SET
...
Rithu Gokul is a scholar at National Centre for Biological Sciences. His project is in understanding the factors shaping tree growth allometry across Indian forests and formulating regional and site-specific height-diameter equations. His work focuses statistical modelling using bioclimatic variables across environmental gradients to address spatial and ecological questions.
...
<!--[Explore our sites](https://inventree-paper-explorer.shinyapps.io/inventree_plots_explorer_v1/?data_owner=TR%20Shankar%20Raman#map){.btn .btn-primary target=_blank}-->
