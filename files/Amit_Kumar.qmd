---
title: "Amit Kumar" #THIS NEEDS TO BE MANUALLY SET
categories: 
 - faculty
 - data owner
---
...
memberid <- "M16" # THIS NEEDS TO BE MANUALLY SET
...
Amit Kumar is a Professor of Geography with a research focus on ecological hazards and risks across forested and rapidly urbanizing landscapes. His work integrates machine learning, remote sensing, and geospatial technologies to understand and support the resilience of ecosystems and the sustainability of human-environment interactions. His research spans diverse environments—from megacities to biodiverse forested frontiers—bridging biophysical and socio-ecological perspectives for sustainable development, and climate adaptation.

*Keywords:* `r member$keywords`

*Study sites:* `r member$sites`  

[Explore our sites](https://inventree-paper-explorer.shinyapps.io/inventree_plots_explorer_v1/?data_owner=Amit%20Kumar#map){target=_blank .btn .btn-primary}    
