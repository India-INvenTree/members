---
title: "Karun Jose" #THIS NEEDS TO BE MANUALLY SET
categories: 
 - working group
 - scientist
 - data owner
...
memberid <- "M23" # THIS NEEDS TO BE MANUALLY SET
...
Karun Jose is a Ph.D. scholar at BITS Pilani, Goa Campus. His research focuses on assessing the impacts of climate change on tropical forests using a combination of ground-based and remote sensing approaches. He integrates long-term phenological observations from PhenoCams and satellites with dynamic vegetation modeling (PlantFATE) to understand and project community-level responses to future climate scenarios.

*Keywords:* `r member$keywords`

*Study sites:* `r member$sites`  

[Explore our sites](https://inventree-paper-explorer.shinyapps.io/inventree_plots_explorer_v1/?data_owner=Karun%20Jose#map){.btn .btn-primary target=_blank}  
