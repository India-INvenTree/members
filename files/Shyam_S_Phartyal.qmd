---
title: "Shyam S. Phartyal" #THIS NEEDS TO BE MANUALLY SET
categories: 
 - faculty
---
...
memberid <- "M41" # THIS NEEDS TO BE MANUALLY SET
...
Shyam S. Phartyal is a Professor in the Department of Forestry at Mizoram University, Aizawl, where he leads the WiSE (Wild Seed Ecology) Lab. His research focuses on the seed ecological traits of wild plant species across ecosystems ranging from wetlands to woodlands. He also works on citizen science, plant–herbivore interactions, phenology, and microclimate ecology. Shyam is a founding member of SeedArc (Global Archive of Primary Seed Germination Data) and a consortium member of major global ecological networks, including the Tropical Seed Trait Database, SoilTemp Database, sPlot, and HerbVar.
