---
title: "A. P. Madhavan " #THIS NEEDS TO BE MANUALLY SET
categories: 
 - research assistant
 - data owner
---
...
memberid <- "M34" # THIS NEEDS TO BE MANUALLY SET
...
A. P. Madhavan is a researcher within NCF working for the Ecosystem Recovery Monitoring project (ERM) under the aegis of the ERA (ecological restoration alliance). He aids in expanding understandinding of long-term secondary forest recovery dynamics across landscapes and management types. He is interested to understand how empirical and observational information can be bridged to expand the restoration narrative.
...
[Explore our sites](https://inventree-paper-explorer.shinyapps.io/inventree_plots_explorer_v1/?data_owner=AP%20Madhavan#map){target=_blank}{.btn .btn-primary}    
