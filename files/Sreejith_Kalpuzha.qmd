---
title: "Sreejith Kalpuzha" #THIS NEEDS TO BE MANUALLY SET
categories: 
 - faculty
 - data owner
---
...
memberid <- "M13" # THIS NEEDS TO BE MANUALLY SET
...
Dr. Sreejith Kalpuzha Ashtamoorthy is a Principal Scientist and Head of the Department of Forest Ecology at the Kerala Forest Research Institute (KFRI). For over two decades, he has been actively involved in field-oriented ecological studies, with a primary focus on the tropical forests of the Western Ghats. His research areas include long-term monitoring of tropical forest ecosystems, vegetation dynamics, and climate change impacts on forest ecosystems. He is an active member of global research networks such as Forest Plots and the Global Ecosystem Monitoring Network.
...
[Explore our sites](https://inventree-paper-explorer.shinyapps.io/inventree_plots_explorer_v1/?data_owner=KA%20Sreejith#map){.btn .btn-primary target=_blank}
