---
title: "Rajiv Kumar Chaturvedi" #THIS NEEDS TO BE MANUALLY SET
categories: 
 - faculty
 - data owner
---
...
memberid <- "M28" # THIS NEEDS TO BE MANUALLY SET
...
Rajiv Kumar Chaturvedi is an Associate Professor at BITS
Pilani, K. K. Birla Goa Campus, where he leads research on climate change, forests, and
environmental policy. His work focuses on the interactions between climate, forests, and
ecosystems, with an emphasis on greenhouse gas inventories, land-use change, and
climate policy. He has contributed to India’s national communications and biennial
update reports to the UNFCCC, served as a lead author for IPCC and IPBES assessments,
and co-developed global climate policy tools.
...
[Explore our sites](https://inventree-paper-explorer.shinyapps.io/inventree_plots_explorer_v1/?data_owner=Rajiv%20Kumar%20Chaturvedi#map){.btn .btn-primary target=_blank}  
