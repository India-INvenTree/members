---
title: "Jayashree Ratnam" #THIS NEEDS TO BE MANUALLY SET
categories: 
 - faculty
 - data owner
---
...
memberid <- "M32" # THIS NEEDS TO BE MANUALLY SET
...
Jayashree Ratnam is currently at the National Centre for Biological Sciences, Tata Institute of Fundamental Research where she serves as Director of the Wildlife Biology and Conservation Program. She is particularly interested in the history, ecology, function and conservation of tropical savannas, forests and grasslands. Current work includes paleo-history and functional ecology of Asian savannas and grasslands, and long-term monitoring of Asian tropical forests and savannas.

*Keywords:* `r member$keywords`

*Study sites:* `r member$sites`  

[Explore our sites](https://inventree-paper-explorer.shinyapps.io/inventree_plots_explorer_v1/?data_owner=Jayashree%20Ratnam#map){target=_blank}{.btn .btn-primary}    
