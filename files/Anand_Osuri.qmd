---
title: "Anand Osuri" #THIS NEEDS TO BE MANUALLY SET
categories: 
 - scientist
 - data owner
---
...
memberid <- "M19" # THIS NEEDS TO BE MANUALLY SET
...
Anand M Osuri is an ecologist specializing in community ecology, ecosystems ecology, restoration ecology, and biodiversity conservation. His research focuses on understanding the impacts of anthropogenic disturbance and climate change on biodiversity, vegetation dynamics, and carbon cycling in tropical rainforests. His research also focuses on understanding the abiotic and biotic barriers that limit recovery of rainforests that have been previously degraded, and evaluating the performance and cost-effectiveness of alternative strategies for overcoming these barriers and ecologically restoring tropical forests.

*Keywords:* `r member$keywords`

*Study sites:* `r member$sites`  

[Explore our sites](https://inventree-paper-explorer.shinyapps.io/inventree_plots_explorer_v1/?data_owner=Anand%20Osuri#map){target=_blank}{.btn .btn-primary}    
